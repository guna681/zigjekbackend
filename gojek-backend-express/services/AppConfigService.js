module.exports = function () {
  ...
  this.authTypeChecking = async (name) => {
    ...
    return new Promise(async function (resolve) {
      try {
        ...
        var autypecheckres = await appConfigRepository.authTypeCheck(senddata)
  ...
  this.getSMTPConfig = () => {
    ...
    return new Promise(function (resolve) {
      try {
        ...
        appConfigRepository.authType(condition, smtp, (result) => {
          if (result.error) {
            response.error = true
          } else {
            var config = {}
  ...
  this.getEmailTemplate = async (keyWord) => {
    ...
    return new Promise(async function (resolve) {
      try {
        var template = await appConfigRepository.fetchEmailTemplate(keyWord)
        if (template.error) {
          response.error = true
  ...
  this.getEmailTemplateList = (id) => {
    ...
    return new Promise(async function (resolve) {
      try {
        var emailtemplate = await appConfigRepository.fetchEmailTemplate(id)
