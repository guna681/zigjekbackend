  ...
  this.commonSearchViewService = async (datas, callback) => {
    ...
    switch (typename) {
      case 'users':
        ...
        var resresult = []
        try {
          var usersSDCount = await searchRepository.usersSearchDataListCount(udata)
          var usersSDListSData = await searchRepository.usersSearchDataListView(udata)
          if (usersSDListSData.error === false && usersSDCount.error === false) {
            usersSDListSData.data.forEach((j, index) => {
      ...
      case 'providers':
        ...
        try {
          ...
          var providersSDListSData = await searchRepository.usersSearchDataListView(pdata)
      ...
      case 'country':
        try {
          var data = {}
          var countrycount = await searchRepository.commonSearchDataListCount(data)
          var adminSCountryData = await searchRepository.commonSearchDataListView(data)
          var cresult = []
      ...
      case 'bookings':
        try {
          ...
          var bookingcount = await searchRepository.bookingSearchDataListView(bdata)
          var bookingData = await searchRepository.bookingSearchDataListView(bdata)
          var bresult = []
